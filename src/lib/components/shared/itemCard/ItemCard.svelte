<script lang="ts">
	...
	interface DashboardKitProduct {
		productId : string;
		quantity  : number;
		product?  : { id : string; name : string; sku : string };
	}

	interface DashboardKit {
		id          : string;
		sku         : string;
		name        : string;
		description : string;
		...
		products    : DashboardKitProduct[];
	}

	interface DashboardLabProduct {
		productId : string;
		quantity  : number;
		product?  : { id : string; name : string; sku : string };
	}

	interface DashboardLabKit {
		kitId    : string;
		quantity : number;
		kit?     : { id : string; name : string; sku : string };
	}

	interface DashboardMobileLab {
		id          : string;
		sku         : string;
		name        : string;
		description : string;
		...
		files       : Array<{ id : string; url : string; alt : string; isMain : boolean }>;
		category    : { id : string; name : string };
		products    : DashboardLabProduct[];
		kits        : DashboardLabKit[];
	}
